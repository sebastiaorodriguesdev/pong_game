...
def instantiate_game_objects():
    ...
    #input handlers
    input_handler_paddle1 = InputHandler(paddle1, pygame.K_w, pygame.K_s, game_state)
    input_handler_paddle2 = InputHandler(paddle2, pygame.K_UP, pygame.K_DOWN, game_state)
    ...
    return paddles, input_handlers, ball, drawables, players, game_state